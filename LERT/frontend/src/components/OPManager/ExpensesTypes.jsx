...
export const ExpensesTable = () => {
  ...
  // const URL = "https://lert-api.mybluemix.net/expensesTypes";
  ...
  const fetchData = () => {
    axios({
      method: "get",
      url: "https://lert-api.mybluemix.net/expensesTypes",
      responseType: "json",
            ...
            {expenseData.map((row) => (
              ...
              >
                <TableCell component="th" scope="row">
                  <IconButton onClick={(e) => deleteExpenseTypeRecord(e, row)}>
                    <DeleteOutlined />
                  </IconButton>
                </TableCell>
...
export function postNewExpenseType(eName) {
  const axios = require("axios").default;
  axios
    .post("https://lert-api.mybluemix.net/newExpenseType", {
      name: eName,
    })
    .then(function (response) {
...
export function deleteExpenseType(name) {
  const axios = require("axios").default;
  axios
    .delete(`https://lert-api.mybluemix.net/delExpenseType/${name}`)
    .then(function (response) {
      console.log(response);
    })
    .catch(function (error) {

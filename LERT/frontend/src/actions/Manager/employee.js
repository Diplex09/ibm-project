export const postNewEmployee = async (record) => {
  ...
  await axios
    .post("https://lert-api.mybluemix.net/newPostEmployee", {
...
export const deleteEmployee = async (id) => {
  const axios = require("axios").default;
  axios
    .delete(`https://lert-api.mybluemix.net/deleteEmployees/${id}`)
...
export const updateEmployee = async (id, editRecord) => {
  const axios = require("axios").default;
  await axios
    .put(`https://lert-api.mybluemix.net/updateEmployees/${id}`, {

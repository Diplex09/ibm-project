...
var Popper = _interopDefault(require('@mui/material/Popper'));
...
var getBorderColor = function getBorderColor(theme) {
  return theme.palette.mode === 'light' ? styles$e.lighten(styles$e.alpha(theme.palette.divider, 1), 0.88) : styles$e.darken(styles$e.alpha(theme.palette.divider, 1), 0.68);
};
var PREFIX = 'Target';
var classes = {
...
var withClassName = function withClassName() {
  ...
  return function (Target) {
    return styles$e.styled(dxReactChart.withPatchedProps(setClassName)(Target)).apply(void 0, args);
  };
};
...
var Point = styles$e.styled(dxReactChart.withPatchedProps(setClassName)(dxReactChart.ScatterSeries.Point))(function (_ref) {
  var theme = _ref.theme;
...
var StyledPopper = styles$e.styled(Popper)(function () {
...
var Root$3 = styles$e.styled('div')(function (_ref) {
  var _ref2;

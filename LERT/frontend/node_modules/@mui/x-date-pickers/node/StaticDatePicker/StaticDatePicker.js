...
const StaticDatePicker = /*#__PURE__*/React.forwardRef(function StaticDatePicker(inProps, ref) {
  const props = (0, _shared.useDatePickerDefaultizedProps)(inProps, 'MuiStaticDatePicker'); // Note that we are passing down all the value without spread.
  ...
  const {
    pickerProps,
    inputProps
  } = (0, _usePickerState.usePickerState)(props, _shared.datePickerValueManager);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_PickerStaticWrapper.PickerStaticWrapper, {

...
const classes = (0, _material.generateUtilityClasses)('MuiPickersArrowSwitcher', ['root', 'spacer', 'button']);
...
const PickersArrowSwitcher = /*#__PURE__*/React.forwardRef(function PickersArrowSwitcher(props, ref) {
  ...
  const LeftArrowIcon = components.LeftArrowIcon || _icons.ArrowLeft;
  const rightArrowButtonProps = componentsProps.rightArrowButton || {};
  const RightArrowIcon = components.RightArrowIcon || _icons.ArrowRight;

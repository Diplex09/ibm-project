...
export var ClockPicker = /*#__PURE__*/React.forwardRef(function ClockPicker(inProps, ref) {
      ...
      case 'hours':
        {
          ...
          var dateWithNewHours = utils.setHours(date, value);
      ...
      case 'minutes':
        {
          ...
          var dateWithNewMinutes = utils.setMinutes(date, rawValue);
      ...
      case 'seconds':
        {
          ...
          var dateWithNewSeconds = utils.setSeconds(date, rawValue);
  ...
  }, [ampm, date, disableIgnoringDatePartForTimeValidation, maxTime, meridiemMode, minTime, minutesStep, shouldDisableTime, utils]);

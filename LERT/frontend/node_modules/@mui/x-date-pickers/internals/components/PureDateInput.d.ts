...
export declare type ExportedDateInputProps<TInputDate, TDate> = Omit<DateInputProps<TInputDate, TDate>, 'inputFormat' | 'inputValue' | 'onBlur' | 'onChange' | 'open' | 'openPicker' | 'rawValue' | 'TextFieldProps' | 'validationError'>;
